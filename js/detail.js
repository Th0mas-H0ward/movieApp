...
fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}?api_key=${api_key}&append_to_response=casts,videos,images,releases&language=${languages}`, function (movie) {
  ...
  document.title = `${title} - PopTop Kino`;
  ...
  <div class="detail-box">
    ...
    <div class="detail-content">
      ...
      <div class="meta-list">
        ...
        <div class="meta-item">${runtime} хв</div>
      ...
      <ul class="detail-list">
        ...
        <div class="list-item">
          <p class="list-name">У ролях:</p>

          <p>${getCasts(cast)}</p>
        </div>

        <div class="list-item">
          <p class="list-name">Режисери:</p>
    ...
    <div class="title-wrapper">
      <h3 class="title-large">Трейлери та кліпи</h3>
    </div>
  ...
  fetchDataFromServer(`https://api.themoviedb.org/3/movie/${movieId}/recommendations?api_key=${api_key}&page=1&language=uk-UA`, addSuggestedMovies);
...
const addSuggestedMovies = function ({ results: movieList }, title) {
  ...
  movieListElem.ariaLabel = "Вам також може сподобатись";

  movieListElem.innerHTML = `
  <div class="title-wrapper">
  <h3 class="title-large">Вам також може сподобатись</h3>
</div>
